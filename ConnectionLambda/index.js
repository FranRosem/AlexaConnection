...
const LaunchRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        const speakOutput = 'Welcome to your \'Temperature or Humidity\' Project. What do you want to know?.';
...
const TemperatureIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        //const speechText = `La distancia es ${sensorData.distance}`;
        return handlerInput.responseBuilder
